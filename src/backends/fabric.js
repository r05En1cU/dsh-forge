import { createForgeEvent } from '../dispatch.js';
/**
 ...
 */
export function createFabricBackend(options = {}) {
    return {
        name: 'fabric',
        ...
        bind(ctx, point, hooks, bindOptions) {
            ...
            fabric.register({
                id: point.id,
                target: spec.target, // structural mirror of FabricTarget; verified by fabric's own validator
